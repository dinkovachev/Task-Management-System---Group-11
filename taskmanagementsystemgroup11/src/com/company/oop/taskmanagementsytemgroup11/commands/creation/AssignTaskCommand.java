...
public class AssignTaskCommand extends BaseCommand {
    ...
    // 2. created method void assignTask(Members memberToAssignTask, Task taskToBeAssigned) in Members Interface so that
    // a member from the team to be able to assign tasks
    // 3. created method void assignTask(Task task); in Task interface so that task can have the functionality to be assigned
