...
public class FeedbackImpl extends TaskImpl implements Feedback {
    ...
    public void advanceStatus() {
        if (getStatus() == Status.NEW) {
            ...
            System.out.println(FEEDBACK_STATUS_SET_TO_UNSCHEDULED_MESSAGE);
            ...
            System.out.println(CHANGED_FEEDBACK_STATUS_TO_SCHEDULED_MESSAGE);
        } else if (getStatus() == Status.SCHEDULED) {
            setStatus(Status.DONE);
            addEventToActivityLogHistory(FEEDBACK_STATUS_SET_TO_DONE_MESSAGE);
            System.out.println(FEEDBACK_STATUS_SET_TO_DONE_MESSAGE);
        } else {
            addEventToActivityLogHistory(FEEDBACK_STATUS_IS_ALREADY_DONE);
            System.out.println(FEEDBACK_STATUS_IS_ALREADY_DONE);
        }
    }
    ...
    public void revertStatus() {
        if (getStatus() == Status.DONE) {
            ...
            System.out.println(FEEDBACK_STATUS_SET_TO_NEW);
        } else {
            addEventToActivityLogHistory(FEEDBACK_STATUS_IS_ALREADY_NEW_MESSAGE);
            System.out.println(FEEDBACK_STATUS_IS_ALREADY_NEW_MESSAGE);
        }
    }
